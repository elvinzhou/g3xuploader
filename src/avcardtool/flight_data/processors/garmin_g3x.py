...
class GarminG3XProcessor(FlightDataProcessor):
    ...
    COL_GPS_ALTITUDE = 6
    COL_GPS_FIX = 7
    COL_GPS_TIME_OF_WEEK = 8
    COL_GROUND_SPEED = 9  # GPS Ground Speed (kt)
    COL_TRACK = 10  # GPS Ground Track (deg)
    COL_HDG = 14  # Magnetic Heading (deg)
    COL_PRESSURE_ALT = 18  # Pressure Altitude (ft)
    COL_BARO_ALT = 19  # Baro Altitude (ft)
    COL_VERTICAL_SPEED = 20  # Vertical Speed (ft/min)
    COL_IAS = 21  # Indicated Airspeed (kt)
    COL_TAS = 22  # True Airspeed (kt)
    COL_PITCH = 23  # Pitch (deg)
    COL_ROLL = 24  # Roll (deg)
    COL_RPM = 85  # E1 RPM (Column CH/86 in Excel, index 85 in Python)
    COL_OIL_PRESS = 86  # E1 OilP (psi) (Column CI/87 in Excel, index 86 in Python)
    COL_OIL_TEMP = 87  # E1 OilT (degF) (Column CJ/88 in Excel, index 87 in Python)
    COL_CHT1 = 62  # E1 CHT1 (degF)
    COL_CHT2 = 63  # E1 CHT2 (degF)
    COL_EGT1 = 68  # E1 EGT1 (degF)
    COL_EGT2 = 69  # E1 EGT2 (degF)
