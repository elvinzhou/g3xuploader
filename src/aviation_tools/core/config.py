...
class SystemConfig:
    ...
    data_dir: str = "/var/lib/aviation_tools"
    log_file: str = "/var/log/aviation_tools.log"
    log_level: str = "INFO"
...
class Config:
    ...
    DEFAULT_CONFIG_PATHS = [
        ...
        Path.home() / ".config" / "aviation_tools" / "config.json",
        Path.home() / ".aviation_tools" / "config.json",
    ]
